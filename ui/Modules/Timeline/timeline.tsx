...
class TimelineLibrary extends Component<Props, {}> {
	...
	componentDidMount() {
		Object.defineProperty(this, 'timeline', {
			value: new VisTimelineCtor(this._ref.current, this.items, this.groups, this.props.options),
			writable: false
		});
...
module.exports = TimelineLibrary